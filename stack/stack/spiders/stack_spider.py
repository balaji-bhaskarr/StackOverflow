...
class StackSpider(Spider):
    ...
    def parse(self, response):
        ...
        for question in questions:
            ...
            yield item
'''               
  //*[@id="questions"]/div/div[2]/h3/a
  //*[@id="question-summary-78534157"]
  //*[@id="question-summary-78534157"]/div[2]/h3/a
  
  //*[@id="question-summary-78534157"]/div[2]/h3/a[@class="s-link"]/text()
'''